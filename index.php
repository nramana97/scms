  ...
  <head>
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center justify-content-between">
        <h1 class="logo">
          <a href="./index.php"
            ><img src="./imgs/logo.png" alt="" style="object-fit:cover;"
          /></a>
        </h1>
    ...
    <section id="hero">
      <div class="hero-container" data-aos="fade-up" data-aos-delay="150">
        <h1>Identify. Report. Solved.</h1>
        <h2>
            Don't let the problems take over you
        </h2>
        <div class="d-flex">
          <a href="#about" class="btn-get-started scrollto bg-dark text-light ">Login</a>
        </div>
      </div>
    </section>

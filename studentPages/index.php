...
<body class="overflow-x-hidden gap-0 scroll-hide">
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav  gap-2  mb-2 mb-lg-0">
                                <li class="nav-item " data-bs-dismiss="offcanvas">
                                    <a class="nav-link " aria-current="page" target="content_frame" href="./landing.html"><i
    ...
    <div class=" relative flex h-[100vh] flex-row  w-[100vw] mt-0 overflow-y-scroll ">
        <iframe src="left.html" class="max-md:hidden relative " frameborder="0" class="flex-1 max-w-m overflow-hidden px-1" width="200px"
